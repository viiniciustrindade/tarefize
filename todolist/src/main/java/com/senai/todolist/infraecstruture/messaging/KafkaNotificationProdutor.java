...
import com.senai.todolist.service.task.NotificationService;
...
public class KafkaNotificationProdutor implements NotificationService {
    ...
    @Override
    public void enviar(NotificationEvent evento) {
